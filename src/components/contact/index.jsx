...
<div className="relative w-full h-[600px]">
    ...
    <div className="relative z-10  flex  items-center container justify-between mx-auto max-w-[1280px] px-4 py-20">
        <div className="w-[45%] flex flex-col gap-2 ">
            <h3 className="text-[32px] text-[white] uppercase font-bold  mb-[10px] poppins">
                "AQVO" bilan yangicha ta’mni his eting.
            </h3>
            <p className="text-[18px] text-white max-w-[800px] mb-2">
            ...
            <p className="text-[18px] text-white mb-2">Bog‘lanish uchun telefon raqamlarimiz:</p>
            <div className="flex flex-col gap-1 text-white text-[15px]">
                <Link className='text-[18px] ' href="tel:+998957724444">Tel: +998 95 772 44 44</Link>
                <Link className='text-[18px] '  href="tel:+998996440101">Tel: +998 99 644 01 01</Link>
            </div>
        </div>
        <div className="w-[45%] ">
            <ContactForm/>
