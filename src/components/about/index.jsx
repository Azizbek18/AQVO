...
function AboutPage() {
  return (
    <div className="relative w-full h-[700px]">
      ...
      <div className=" container mx-auto max-w-[1280px] relative z-10 flex flex-col pt-[120px] py-[60px] justify-center h-full px-4">
        <h3 className="text-[32px] text-center text-white uppercase font-bold poppins">
          Bizning sertifikatlarimiz
        </h3>
        <div className="flex gap-4 pb-[60px] pt-[15px] ">
            ...
            <div className="relative w-[400px] h-[450px] ">
                <Image fill className='w-full h-full object-cover ' alt='Photo' src="/images/sertifikat.png" />
            </div>
            <div className="relative w-[400px] h-[450px] ">
                <Image fill className='w-full h-full object-cover ' alt='Photo' src="/images/sertifikat.png" />
            </div>
