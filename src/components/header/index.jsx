  ...
  return (
    <div className='bg-red-800'>
      <div className="container px-[20px] lg:px-[0] py-[20px] mx-auto max-w-[1280px]">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <div className="relative w-full max-w-[80px] mx-auto">
              <button
                ...
                className="w-full flex items-center justify-between rounded-xl px-4 py-1 bg-[#441118a1] text-white focus:outline-none transition"
              >
              ...
              {isOpen && (
                <ul className="absolute z-10 mt-2 w-full bg-white border border-gray-200 rounded-xl shadow-md max-h-[300px] overflow-y-auto animate-fadeIn">
            ...
            <button
              ...
              className='hidden lg:flex justify-center items-center bg-[#a78861] text-white font-[600] text-[18px] w-[150px] lg:w-[240px] h-[44px] rounded-[20px]'
            >
              Bog'lanish
            </button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 bg-[#00000080] z-[100] backdrop-blur-sm">
            ...
            <Image fill className='object-contain' src='/images/logo.png' alt='Sayt logosi' />
              ...
              <nav className="flex flex-col gap-4">
                <Link href="/" onClick={() => setMobileMenuOpen(false)} className=" text-red-500 text-[18px] font-[500]">Bosh sahifa</Link>
                <Link href="/hero" onClick={() => setMobileMenuOpen(false)} className="text-red-500 text-[18px] font-[500]">Biz haqimizda</Link>
                <div className="flex gap-3 justify-between pt-4">
                  {services.map((lang, i) => (
                    <button
                      ...
                      className={`w-full flex border-2 border-red-500 text-red-500 oswald justify-center text-left py-1 px-2 rounded-[30px] hover:bg-gray-200 ${selected === lang ? 'bg-gray-200' : ''}`}
                    >
                      {lang}
                    </button>
                  ))}
